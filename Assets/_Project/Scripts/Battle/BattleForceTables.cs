...
namespace Voidovia
{
    ...
    public static class BattleForceTables
    {
        ...
        /// <summary>A mixed Void patrol — proper soldiers, not rabble. Losing to them or beating them both
        /// carry weight; a win captures Voidovia troops (recruitable into the Void tree).</summary>
